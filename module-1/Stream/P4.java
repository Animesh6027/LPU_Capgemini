/* Write a Java Stream one-liner to sort Students objects by marks and print them. */
...
public class P4 {
	public static void main(String[] args) {
        ...
        st.stream().sorted((s1,s2) -> Double.compare(s1.marks, s2.marks)).forEach(System.out::println);
